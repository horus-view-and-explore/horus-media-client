...
from horus_media import Client, ImageRequestBuilder, ImageProvider, Mode, Size, Direction
...
request = client.fetch(request_builder.build(mode, None, None, size, direction))
